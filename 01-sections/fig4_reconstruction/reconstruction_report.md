...
2. **空间方向解耦**：
   - **X轴剪切力 ($F_x$)**：基于横向点位的压力差，相关系数可根据实际标定作进一步微调。
     $F_x = k_x \cdot (P_2 + P_4 - P_1 - P_3)$ （目前设定 $k_x = 1.0$）
   - **Y轴剪切力 ($F_y$)**：基于纵向点位的压力差。
...
所有的图片文件都存放在 `./renders/` 目录下。

### 🟢 动作 1：动态抓法 (Dynamic Grasping)
- 对应切片：Strain (s) | 3D Force (m) | Tribo (g)

![Action 1 - Strain](./renders/figure_strain_array/Strain_Angle_Grid_Nx3_s.png)
![Action 1 - 3D Force](./renders/figure_3d_force/3D_Force_Grid_Nx3_m.png)
![Action 1 - Tribo](./renders/figure_tribo_array/Tribo_Grid_Nx3_g.png)
...
![Action 2 - Strain](./renders/figure_strain_array/Strain_Angle_Grid_Nx3_t.png)
![Action 2 - 3D Force](./renders/figure_3d_force/3D_Force_Grid_Nx3_n.png)
![Action 2 - Tribo](./renders/figure_tribo_array/Tribo_Grid_Nx3_h.png)
...
![Action 3 - Strain](./renders/figure_strain_array/Strain_Angle_Grid_Nx3_u.png)
![Action 3 - 3D Force](./renders/figure_3d_force/3D_Force_Grid_Nx3_o.png)
![Action 3 - Tribo](./renders/figure_tribo_array/Tribo_Grid_Nx3_i.png)
...
![Action 4 - Strain](./renders/figure_strain_array/Strain_Angle_Grid_Nx3_v.png)
![Action 4 - 3D Force](./renders/figure_3d_force/3D_Force_Grid_Nx3_p.png)
![Action 4 - Tribo](./renders/figure_tribo_array/Tribo_Grid_Nx3_j.png)
...
![Action 5 - Strain](./renders/figure_strain_array/Strain_Angle_Grid_Nx3_w.png)
![Action 5 - 3D Force](./renders/figure_3d_force/3D_Force_Grid_Nx3_q.png)
![Action 5 - Tribo](./renders/figure_tribo_array/Tribo_Grid_Nx3_k.png)
...
![Action 6 - Strain](./renders/figure_strain_array/Strain_Angle_Grid_Nx3_x.png)
![Action 6 - 3D Force](./renders/figure_3d_force/3D_Force_Grid_Nx3_r.png)
![Action 6 - Tribo](./renders/figure_tribo_array/Tribo_Grid_Nx3_l.png)
...
![Strain Sensitivity Calibration Result](../strain_sensitivity/renders/SI-3.png)
