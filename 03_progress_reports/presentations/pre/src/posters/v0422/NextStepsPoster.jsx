...
function NextStepsPoster() {
  const steps = [
    ...
    { num: '4.15~4.21', title: '4月第三周', status: 'done', color: '#94a3b8', tags: ['实证实验数据闭环', 'Method/Results成文'], desc: '完成验证实验；集中讨论论文整体设计（Fig 1 - Fig 5）的 Results 段落，并推进 SI 部分内容的整理。' },
    { num: '4.22~4.28', title: '4月第四周', status: 'active', color: '#ea580c', tags: ['核心摘要与引言落笔', '全文逻辑脉络梳理'], desc: '进一步解决手部姿态解析方法，确定全文逻辑主线并组装主干内容。' },
    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '0 0 1rem 0', height: '100%', position: 'relative' }}>
      <div style={{ marginBottom: '1.2rem' }}>
        <div className="glass-badge" style={{
          ...
          <span style={{ color: '#0f172a', fontWeight: 700 }}>下一步计划 (Next Steps)</span>
        </div>
      </div>

      <h2 style={{ fontSize: '2.8rem', fontWeight: 1000, color: '#0f172a', marginBottom: '1.8rem', letterSpacing: '-0.04em' }}>
        全栈攻坚 <span className="text-gradient">任务池与里程碑</span>
      </h2>
