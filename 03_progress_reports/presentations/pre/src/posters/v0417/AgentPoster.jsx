   ...
   return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '1rem 0', position: 'relative' }}>
         ...
         <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
            <div>
               <div className="glass-badge" style={{ padding: '6px 16px', marginBottom: '10px', display: 'inline-block' }}>
               ...
               <h2 style={{ fontSize: '2.5rem', fontWeight: 800, color: '#0f172a', margin: 0 }}>
                  <span className="text-gradient" style={{ background: 'linear-gradient(135deg, #3b82f6, #8b5cf6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>视觉-触觉协同智能体</span> 架构设计
               </h2>
            </div>
         </div>
